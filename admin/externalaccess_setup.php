...
//$context = new Context();
_print_input_form_part('EACCESS_ROOT_URL',false,'',array('size'=> 50, 'placeholder'=>'http://'),'input','EACCESS_ROOT_URL_HELP');
print '<tr>';
...
function _print_input_form_part($confkey, $title = false, $desc ='', $metas = array(), $type='input', $help = false)
{
    ...
    if($type=='textarea'){
        ...
        //print '<textarea class="flat" '.$metascompil.'  >'.dol_htmlentities($conf->global->{$confkey}).'</textarea>';
    }
    else {

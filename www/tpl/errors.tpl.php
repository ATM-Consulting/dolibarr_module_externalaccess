...
print '
	<div class="modal fade" id="ea_errors" tabindex="-1" role="dialog" aria-labelledby="ea_errors_title" aria-hidden="true">
...
print '				
	...
	<script type="text/javascript">$(function(){ $("#ea_errors").modal(); });</script>
';

...
- FIX security breach : backtrack "FIX : copy of the attachment in the ticket => force trackid" *1.36.2* - **08/03/2023**
...
- FIX : copy of the attachment in the ticket => force trackid *1.35.1* - **06/03/2023**
